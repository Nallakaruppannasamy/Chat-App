            ...
            <div className='pb-5'>
                <div className='flex justify-between items-center'>
                    ...
                    <div className="flex items-center gap-3">
                        <FiLogOut onClick={logout} className={`text-xl text-white cursor-pointer hover:text-red-500 `} title="Logout"/>

                        <img onClick={() => navigate('/profile')} src={authUser?.profilePic || assets.avatar_icon} alt="profile" className="w-10 h-10 rounded-full cursor-pointer border border-gray-500 object-cover" />
                    </div>
                </div>
